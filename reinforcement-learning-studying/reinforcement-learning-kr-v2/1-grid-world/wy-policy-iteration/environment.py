...
class GraphicDisplay(tk.Tk):
    ...
    def _build_canvas(self):
        ...
        canvas.create_image(50, 50, image=self.shapes[2])
        canvas.create_image(350, 350, image=self.shapes[2])
...
class Env:
    def __init__(self):
        ...
        self.reward[1] = [0, 0, 0, 0]
        self.reward[2] = [0, 0, 0, 0]
        self.reward[3] = [0, 0, 0, 0]

       # self.reward[2][2] = 0  # (2,2) 좌표 동그라미 위치에 보상 1
